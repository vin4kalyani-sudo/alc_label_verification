...
| Testing | JUnit 5, AssertJ, Spring MockMvc, spring-security-test (102 tests, incl. real-OCR end-to-end) |
...
| [docs/test-scenarios.md](docs/test-scenarios.md) | 133 test scenarios with automated and manual evidence |
